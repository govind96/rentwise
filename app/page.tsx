  ...
  return <div className="view-stack">
    ...
    <section className="intelligence-row">
      <article className="ai-brief">
        ...
        <div className="brief-copy"><p className="overline">RENTWISE CHECK-IN</p><h2>You’re on top of things. Here are the three moments worth your attention.</h2><p><strong>{money.format(concentratedDue)}</strong> is concentrated across the two largest balances, <strong>{availableBeds} beds</strong> are ready to allot, and one urgent repair needs review.</p></div>
